...
For the best visual experience, install IBM Plex fonts:

1. Download IBM Plex Sans and IBM Plex Sans Condensed from [Google Fonts](https://fonts.google.com/specimen/IBM+Plex+Sans)
2. Install the fonts on your system
3. Restart R/RStudio

The package works perfectly without these fonts (using system fonts as fallbacks), but IBM Plex fonts provide the intended Furman University branding experience.

```r
# Check font availability after installation
register_furmanu_fonts()
```
